...
def _load_defaults():
    try:
        from src.config.settings import IMAGE_OUTPUT_DIR, IMAGE_TO_PDF_OUTPUT_DIR, PDF_TO_JPG_CONFIG
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="CLI unificada: extract, pdf2jpg, img2pdf")
